...
public:
	...
	float speed = 2.0f;  // Extremely fast base speed
	float sensitivity = 100.0f;

	void SetPosition(glm::vec3 position) { Position = position; } // Sets the position of the camera
	glm::vec3 GetPosition() { return Position; } // Returns the position of the camera
